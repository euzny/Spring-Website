...
<div class="page-list"> <!-- 페이지 목록(번호)가 표시될 곳 -->

	<c:if test="${page.curBlock gt 1}"> <!-- gt 는 '>'와 같은 의미 -->
	...
	<c:if test="${page.curBlock lt page.totalBlock}"> <!-- lt 는 '<'와 같은 의미 -->
		<span>&#183;&#183;&#183;</span>
...
<style>
	.page_on, .page_off, .page_next, .page_prev, .page_last, .page_first {

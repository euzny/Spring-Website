 ...
 */
 ...
 var join = {
	...
	id_status : function(id){ //id의 상태 확인
		...
		var reg = /[^a-z0-9]/g;   //소문자, 숫자 외 입력 시 
	...
	id :{ //id의 기준 설정
		invalid : {code:'invalid', desc:'아이디는 영문 소문자, 숫자만 입력가능'},
...
var space = /\s/g; //전체 문자 내 공백이 있는지를 확인 (변수 space에 할당)